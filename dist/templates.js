const n = "", e = `<div class="page-content text-center">
  <article class="post">
...
`, t = `<div class="page-content">
  <article class="post">
    ...
    <div class="content">
      ...
      <p>
        Couples Run (“we,” “us,” or “our”) values your privacy and is committed
        ...
        when you play our game. By using our game, you agree to the collection
      ...
      <ul>
        <li>
          Nickname: Your nickname, which is used to identify you in the game and
          on the leaderboard.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          To store and display your game score on the leaderboard, allowing you
          to compare your performance with other players.
        </li>
      </ul>
      <p>
      ...
      <p>
        We store your information on Firebase Firestore, a secure cloud service
        provided by Google. We take reasonable steps to protect your information
        from unauthorized access, alteration, or disclosure. However, please
        note that no method of internet transmission is 100% secure, and while
      ...
      <ul>
        <li>
          Timestamps: Information about when your data (nickname and score) was
      ...
      <p>
        While Firebase Firestore does not collect personal information like your
        IP address or device details as part of our service, Google may collect
        such data as part of its network infrastructure for security,
        performance, and monitoring purposes. This data is used to maintain the
        service’s stability and security, and it is not shared with us.
      ...
      <p>
        We do not share your personal information (nickname or game score) with
        third parties, except in the following cases:
      </p>
      <ul>
        <li>
          Service Providers: We may share your information with trusted
          third-party service providers, such as Firebase, who help us store and
          manage the data.
        </li>
        <li>
          Legal Compliance: We may disclose your information if required by law,
          to comply with legal obligations, or to protect the rights, property,
          or safety of Couples Run, its users, or others.
        </li>
      </ul>
      ...
      <p>
        ...
        privacy, including the Children’s Online Privacy Protection Act (COPPA)
      ...
      <ul>
        ...
        <li>
          Parental Consent: If you are under 13 years of age, we recommend that
          you obtain parental consent before playing the game or submitting your
          information.
        </li>
      </ul>
      <p>
      ...
      <ul>
        ...
        <li>
          Update: You can modify or update your nickname or score by contacting
          us at printezisn@gmail.com
        </li>
        <li>
