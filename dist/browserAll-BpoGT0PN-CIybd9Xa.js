import { D as w, C as z, m as J, I as q, A as y, T as Q, c as E, w as B, d as tt } from "./index-BqRm_i48.js";
import "./webworkerAll-DQbc7pxG-DsAFnitY.js";
class M {
  /**
...
const nt = K.default ?? K, it = nt(globalThis.navigator), ot = 9, I = 100, st = 0, rt = 0, N = 2, j = 1, at = -1e3, ht = -1e3, lt = 2;
class Z {
  // 2fps
  ...
  constructor(t, e = it) {
    ...
    n.style.width = `${I}px`, n.style.height = `${I}px`, n.style.position = "absolute", n.style.top = `${st}px`, n.style.left = `${rt}px`, n.style.zIndex = N.toString(), this._div = n, this._renderer = t, this._onKeyDown = this._onKeyDown.bind(this), this._onMouseMove = this._onMouseMove.bind(this), globalThis.addEventListener("keydown", this._onKeyDown, !1);
  }
  /**
...
class vt {
   ...
   */
  copyMouseData(t, e) {
    t instanceof D && e instanceof D && (e.altKey = t.altKey, e.button = t.button, e.buttons = t.buttons, e.client.copyFrom(t.client), e.ctrlKey = t.ctrlKey, e.metaKey = t.metaKey, e.movement.copyFrom(t.movement), e.screen.copyFrom(t.screen), e.shiftKey = t.shiftKey, e.global.copyFrom(t.global));
  }
  /**
